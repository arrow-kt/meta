...
import mkapt.MPackage
import mkapt.internal.knownError
import mkapt.internal.typeConstraints
import java.io.File
...
class HigherKindsFileGenerator(
  ...
  private fun genPartiallyAppliedKinds(hk: HigherKind): String {
    ...
    val hkimpl =
      if (appliedTypeArgs.size == 1) "arrow.Kind" else "arrow.Kind${appliedTypeArgs.size}"
